  ...
  <!-- 员工修改的模态框 -->
    ...
    <script type="text/javascript">
    	...
    	function build_page_nav(result){
    		...
    		var firstPageLi = $("<li></li>").append($("<a></a>").append("首页"));//视频中有.attr("href","#")，我们去掉，因为第一次点击的时候总是最后会去加载第一页一下
    		var prePageLi = $("<li></li>").append($("<a></a>").append("&laquo;"));
    		//判断是否有前一页，没有的话首页和前一页添加不能被点击的样式
    		...
    		//视频中有.attr("href","#")
    		//因为如果我们不去掉打开页面第一件事就是点击末页的话
    		//a标签的#会刷新当前页面一次，当我们ajax加载了末页后，因为#的属性又会去刷新一次当前页面
    		//而我们js开头to_page(1)，所以会回到第一页
    		var lastPageLi = $("<li></li>").append($("<a></a>").append("末页"));
    		
    		//判断是否有下一页，没有的话末页和下一页添加不能被点击的样式
    	...
    	//check_item，单页面所有的复选框被选中时，check_all复选框也要被选中
